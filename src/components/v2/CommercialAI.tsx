...
const ACCESS_EVENTS = [
  { initials: 'JM', name: 'James Martinez', role: 'Facilities Mgr', zone: 'Loading Dock 06:42', result: 'Granted — Normal', c: '#10b981', note: 'Expected shift 06:00–14:00 ✓' },
...
const TIMELINE = [
  ...
  { time: '18:02', c: '#14b8a6', text: 'Energy AI: End-of-day load shed. HVAC setback to 74°F. Vampire loads suspended. Security Mesh protected — not shed.' },
      ...
      {subView === 'access' && (
        <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 10, padding: 16 }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--text2)', lineHeight: 1.6, marginBottom: 14 }}>
            Unlike residential access control, commercial AI models shift patterns, role hierarchies, and anomalous cross-zone movement. Access decisions compare against expected behavioral patterns for that role × time × zone combination.
          </p>
